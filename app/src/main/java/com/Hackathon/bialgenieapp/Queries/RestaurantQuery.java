...
public class RestaurantQuery {
    ...
    public static ArrayList<RestaurantShoppingModel> fetchRestaurantData(String requestUrl, int uniqueL) {
        ...
        ArrayList<RestaurantShoppingModel> info = extractFeatureFromJson(jsonResponse,uniqueL);
    ...
    private static ArrayList<RestaurantShoppingModel> extractFeatureFromJson(String jsonResponse, int uniqueL) {
